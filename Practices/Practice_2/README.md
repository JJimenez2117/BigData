...
myList.toSet
//print 
scala.collection.immutable.Set[Int] = Set(1, 6, 7, 3, 4)
...
mutmymap.keys
//print
Iterable[String] = Set(Susana, Ana, Miguel, Luis, Jose)

// 7 b. Add the following value to the map ("Miguel", 23)
mutmymap += ("Miguel" -> 23)

//print mutmymap
scala.collection.mutable.Map[String,Any] = Map(Susana -> 27, Ana -> 23, Miguel -> 23, Luis -> 24, Jose -> 20)
